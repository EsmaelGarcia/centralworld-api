...
const CollectionSongAlbum = mongoose.Schema({
...
CollectionSongAlbum.index({ erc721Address: 1 }, { unique: true });

CollectionSongAlbum.methods.toJson = function () {
  return {
...
mongoose.model('CollectionSongAlbum', CollectionSongAlbum);
